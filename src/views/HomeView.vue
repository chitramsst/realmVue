<template class="">
   <div class="absolute top-5 right-5 h-10 w-10 rounded-full bg-red-500 flex items-center justify-center" @click="logout">
            ...
            <div
                ...
                <div class="bg-gray-800 p-6 rounded-lg text-white" v-for="category in categories" :key="category._id">
                    ...
                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <path d="M10 12V17" stroke="currentColor" stroke-width="1" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path d="M14 12V17" stroke="currentColor" stroke-width="1" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path d="M4 7H20" stroke="currentColor" stroke-width="1" stroke-linecap="round"
                            stroke-linejoin="round" />
            ...
            <button class="fixed bottom-4 right-4 flex items-center justify-center w-full"
                @click.prevent="createModalShown = !createModalShown">
                <p

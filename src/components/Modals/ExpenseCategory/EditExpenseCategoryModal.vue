        ...
        <div class="bg-[#2e2e30] flex flex-col border border-[#373738] justify-between shadow-xl shadow-blue-black/20 min-w-[26rem] rounded-xl "
            ...
            <div class="flex  flex-col h-full">
                <div class="flex justify-between items-center p-2 border-b border-[#22262E] px-4 ">
                    <div class="text-md font-medium">Edit Expense Category</div>
...
export default {
    ...
    methods: {
        ...
        async save() {
            ...
            this.saveTag = false;
           // alert(this.category)
            this.$electron('expenses',{section : 'update-expense-category',name : this.name, id: this.category._id}).then((response) => {
